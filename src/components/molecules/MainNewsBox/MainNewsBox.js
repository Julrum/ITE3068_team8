...
const MainNewsBox = () => {
  ...
  let [newslink] = useState("https://news.naver.com/main/read.naver?mode=LSD&mid=shm&sid1=101&oid=421&aid=0005727949"); 
  let [headline] = useState("GS에너지 '국내 최대 규모' 친환경 블루 암모니아 확보");
